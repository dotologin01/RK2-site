document.addEventListener('DOMContentLoaded', function () {
      ...
      if(productGrid){
          products.forEach(product => {
              ...
              viewButton.addEventListener('click', () => {
                  ...
                  window.location.href = `product.html`; // Navigate to product page with product ID
              });
  ...
  function displayProductDetails() {
      ...
      document.getElementById('product-image-details').alt = product.title;
      document.getElementById('product-title-details').textContent = product.title;
      document.getElementById('product-price-details').textContent = product.price;
      document.getElementById('product-availability-details').textContent = product.availability;
      document.getElementById('product-description-details').textContent = product.description;
  ...
  displayProductDetails(); // Загрузить товар на страницу товара
//modal
